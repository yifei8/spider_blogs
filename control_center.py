...
class SpiderMain(object):
    ...
    def startCrawling(self, root_url):
        count = 0
        ...
        while self.url_manager.has_new_url():
            ...
            parsed_data = self.res_parser.parse(new_url, content)
...
if __name__ == "__main__":
    root_url = "http://blog.csdn.net/mwq384807683/article/list"
    spider = SpiderMain()
    spider.startCrawling(root_url)